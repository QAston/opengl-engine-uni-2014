...
WorldObject::WorldObject(shared_ptr<SceneObject> object) { _object = object; }
...
void WorldObject::draw() {
  ...
  glTranslatef(movementTransposition.getPosX(), movementTransposition.getPosY(),
               movementTransposition.getPosZ());
